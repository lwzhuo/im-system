package com.zhuo.imsystem.queue.service;
...
public class ThreadPoolHolder {
    ...
    static {
        Integer threads = Integer.getInteger("thread.pool.threads"); // todo
        Integer queues = Integer.getInteger("thread.pool.queues");  // todo
