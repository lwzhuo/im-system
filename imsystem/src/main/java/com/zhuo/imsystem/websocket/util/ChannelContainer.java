...
//    public static ConcurrentHashMap<Channel,String> CHANNEL_CHANNELID_MAP = new ConcurrentHashMap<>();
    ...
    public static void addChannelGroup(String channelId,ChannelGroup channelGroup){
        CHANNELID_CHANNELGROUPS_MAP.put(channelId,channelGroup);
    }

    public static ChannelGroup getChannelGroupByChannelId(String channelId){
        return CHANNELID_CHANNELGROUPS_MAP.get(channelId);
    }
}
