...
(function() {
    ...
    $.ajax({
        ...
        success : function(data, status, xhr) {
            ...
            // 插入按钮
            console.log("开始插入按钮")
            var join_url = "http://localhost:8081/#/join/"+channelId
            console.log(join_url)
            var button_html = '<a href="'+join_url+'" target=_blank><button type="button" class="Button Button--grey Button--withIcon Button--withLabel">'
